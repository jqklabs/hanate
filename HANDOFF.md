...
2. **목표 커브**: `[160, 240, 330, 450, 600, 820, 1150, 1600, 2200, 3000, 4100, 5500]`
   - 무조커 1월 ~100%, 3월 벽 ~14%, 상점봇(22종·4티어) 7월 이상 ~5%, 승률 0%
   - 특수패: 커먼/레어/에픽/레전더리 22종 — 표는 `docs/기획서.md` §7 · README 상점 줄 참고
...
### D. 추가 시스템 기획 수정 (2026-08-20)

특수패는 **새 HUD·다음 목표 위젯을 만들지 않는다.**
현행 22종 중 시그니처 14종만 남기고 ~65종으로 거의 개편한다.
상세 카탈로그는 `docs/추가시스템-기획.md` §2.3~2.7.
장독대·윷가락·낮술·새타령 등은 보류. 점괘·패단장·춘향 밑장 기획은 유지.
