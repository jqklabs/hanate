...
- **고는 무제한** — n고 문턱은 1~5고 `1.5/2/2.5/3/3.5`, 6고부터 `+0.08(n-5)²`. 보너스 `ceil(n×m/2)`냥, 1~2월만 +1. 캡 되돌리지 말 것.
- **밸런스는 빡빡하게** — 난이도 조정 시 하향보다 상향 우선. 목표 커브(160→12,000, 중반 완만·후반 가속)는 시뮬레이션 기준: 무조커 3월 벽 ~15%, 봇 승률 ~0%.
